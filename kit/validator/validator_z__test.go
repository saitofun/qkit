...
var (
	...
	rtUint                     = reflect.TypeOf(uint(1))
	rtUint8                    = reflect.TypeOf(uint8(1))
	rtUint16                   = reflect.TypeOf(uint16(1))
	rtUint32                   = reflect.TypeOf(uint32(1))
	rtUint64                   = reflect.TypeOf(uint64(1))
